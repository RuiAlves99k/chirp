    ...
    ChirpSnackbarScaffold(
        ...
        ChirpAdaptiveFormLayout(
            ...
            ChirpButton(
                ...
                }, style = ChirpButtonStyle.SECONDARY, modifier = Modifier.fillMaxWidth()
            )
        }
    }
}
...
private fun Preview() {
    ChirpTheme {
        RegisterScreen(state = RegisterState(), onAction = {}, snackbarHostState = remember { SnackbarHostState() })
    }
}
